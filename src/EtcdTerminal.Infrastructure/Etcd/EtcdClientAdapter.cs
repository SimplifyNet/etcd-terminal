...
public sealed class EtcdClientAdapter : IEtcdClient
{
    ...
    private static EtcdKeyValue MapKeyValue(KeyValue kv)
    {
    ...
    private static EtcdPermission MapPermission(Permission perm)
    {
        return new EtcdPermission
        {
    ...
    private static Permission.Types.Type MapPermissionType(PermissionType type)
    {
        return type switch
        {
